...
class VGG(nn.Module):
    ...
    def copy_params_from_vgg16_bn(self, vgg16_bn):
        features = [
            ...
            self.conv4_1.conv4_1_1, self.conv4_1.bn4_1, self.conv4_1.relu4_1_1,
            self.conv4_1.conv4_2_1, self.conv4_1.bn4_2, self.conv4_1.relu4_2_1,
            self.conv4_1.conv4_3_1, self.conv4_1.bn4_3, self.conv4_1.relu4_3_1,
            #self.conv4_4, self.bn4_4, self.relu4_4,
            self.conv5_1.pool4_1,
            self.conv5_1.conv5_1_1, self.conv5_1.bn5_1, self.conv5_1.relu5_1_1,
            self.conv5_1.conv5_2_1, self.conv5_1.bn5_2, self.conv5_1.relu5_2_1,
            self.conv5_1.conv5_3_1, self.conv5_1.bn5_3, self.conv5_1.relu5_3_1,
        ]
